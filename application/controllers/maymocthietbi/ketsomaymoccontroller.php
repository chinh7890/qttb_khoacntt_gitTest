...
class ketsomaymoccontroller extends My_controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('maymocthietbi/thongkemaymocmodel');
	...
	public function index()
	{
		...
		$namthongke=$this->thongkemaymocmodel->laynamthongke();
		...
		$this->load->view('maymocthietbi/ketsomaymoc', $data);
	}
	
	function fetch_user(){  
		$fetch_data = $this->thongkemaymocmodel->make_datatables(
       							$_POST['donvi'],
       							$_POST['tenloai'],
       							$_POST['tennhom'],
       							$_POST['nguongoc'],
       ...
       $output = array(  
            ...
            "recordsTotal"        =>   $this->thongkemaymocmodel->get_all_data(
            																$_POST['donvi'],
											       							$_POST['tenloai'],
											       							$_POST['tennhom'],
											       							$_POST['nguongoc'],
											   								...
											   								$_POST['namsd'],
											   								$_POST['chatluong']),  
            "recordsFiltered"     =>   $this->thongkemaymocmodel->get_filtered_data(
            																$_POST['donvi'],
											       							$_POST['tenloai'],
											       							$_POST['tennhom'],
											       							$_POST['nguongoc'],
    ...
    public function layNamSD() {
        ...
        $arrNam = $this->thongkemaymocmodel->layNamSD($iddonvi);
        echo json_encode($arrNam);
    }

    public function layphongkhobangten(){
		$tendonvi = $this->input->post('tendonvi');
        $arrPhongKho = $this->thongkemaymocmodel->layphongkhobangten($tendonvi);
    ...
    public function xuatfile()
	{
		...
		if($hinhthuc == 'tungtb'){
			$arrThietBi = $this->thongkemaymocmodel->layDSTheoDonVi($madonvi, $namthongke);
		}else{
			$arrThietBi = $this->thongkemaymocmodel->laydulieuTongHop($madonvi, $namthongke);
		}
	...
	public function ketso(){
		...
		$this->thongkemaymocmodel->ketso($nam);
		echo maymocthietbi_url('ketsomaymoccontroller/index');
	}
