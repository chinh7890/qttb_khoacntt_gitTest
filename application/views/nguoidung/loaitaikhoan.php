          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Danh sách loại tài khoản</h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="font-size: 15px">
                      ...
                      <tbody class="them">
                      	 <?php foreach ($tk['mangloaitk'] as $value): ?>
	                        <tr>
	                          <td><?= $value['tenloai']?></td>
	                          <td><?= $value['mota']?></td>
                            ...
                            <?php if ($this->session->userdata('quyenhan') == "1") : ?>
                              <td>
                                  ...
                                  <!-- <a onclick="return dialogDelete()" 
                                    href="<?php echo nguoidung_url('loaitaikhoancontroller/xoaloaitaikhoan/').$value['id']; ?>">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title" style="font-size: 20px; float: left;"><p>Thêm loại tài khoản</p></h2>
      ...
      <form class="form-horizontal form-label-left">
        <div class="modal-body">
          <div class="form-group">
                <label class="control-label col-md-2 col-sm-3 col-xs-12" for="first-name">Tên loại tài khoản</label>
                <div class="col-md-9 col-sm-6 col-xs-12">
                  <input type="text" id="tenloai" name="tenloai" required="required" class="form-control col-md-7 col-xs-12">
                </div>
          </div>
          <div class="form-group">
                <label class="control-label col-md-2 col-sm-3 col-xs-12" for="first-name">Mô tả
                 </label>
                <div class="col-md-9 col-sm-6 col-xs-12">
...
<div class="modal fade" id="modalsua" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title" id="exampleModalLongTitle" style="font-size: 20px; float: left;"><p>Cập nhật quyền hạn</p></h2>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form class="form-horizontal form-label-left" action="capnhatloaitaikhoan" method="POST">
        <div class="modal-body">
          <div class="form-group">
                <label class="control-label col-md-2 col-sm-3 col-xs-12" for="first-name">Tên loại tài khoản </label>
                <div class="col-md-9 col-sm-6 col-xs-12">
                  <input name="idUpdate" id="idUpdate" type="hidden" class="form-control" hidden="hidden" >
                  <input type="text" id="tenloaiUpdate" name="tenloaiUpdate" required="required" class="form-control col-md-7 col-xs-12">
                </div>
          </div>
          <div class="form-group">
                <label class="control-label col-md-2 col-sm-3 col-xs-12" for="first-name">Mô tả 
                ...
                <div class="col-md-9 col-sm-6 col-xs-12">
                  <input type="text" id="motaUpdate" name="motaUpdate" required="required" class="form-control col-md-7 col-xs-12">
                </div>
          </div>
    ...
    {
      var id=obj.id;
      var tenloaiUpdate=($("#"+id).attr("tenloai"));
      var motaUpdate=($("#"+id).attr("mota"));
      document.getElementById("tenloaiUpdate").value = tenloaiUpdate;
      document.getElementById("motaUpdate").value = motaUpdate;
