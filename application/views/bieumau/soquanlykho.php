              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="<?= nguoidung_url('bieumaucontroller/xuatdulieu') ?>" method="POST">
                      ...
                      <button type="submit" class="btn btn-primary" name="action" value="SoKho">IN SỔ QUẢN LÝ KHO</button>
                      <button type="submit" class="btn btn-primary" name="action" value="LyLich">IN SỔ LÝ LỊCH THIẾT BỊ</button>
                      <button type="submit" class="btn btn-primary" name="action" value="TBSanXuat">IN SỔ THIẾT BỊ SẢN XUẤT</button>
                    </form>
                      <a href="<?= public_url('bieumau/BM-TH-05-00 (SoQLKhoTB-CNTT)-BIA.docx') ?>">SỔ QUẢN LÝ KHO THIẾT BỊ (BÌA) (Chọn để tải về)
                              </a>
                  </div>
                </div>
              </div>
