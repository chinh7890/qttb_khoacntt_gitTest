...
<html lang="en">
  <head>
    ...
    <title>Loại thiết bị đồ gỗ</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Danh sách loại thiết bị đồ gỗ</h3>
              </div>
                            ...
                            <?php if ($this->session->userdata('quyenhan') == "1") : ?>
                              <td>
                                  ...
                                  <a class="btn btn-danger" onclick="return dialogDelete()" 
                                    href="<?php echo thietbidogo_url('loaithietbidogocontroller/xoaloaithietbidogo/').$value['id']; ?>"
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title" id="exampleModalLongTitle" style="font-size: 20px; float: left;"><p>Thêm loại thiết bị đồ gỗ</p></h2>
...
<div class="modal fade" id="modalsua" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title" id="exampleModalLongTitle" style="font-size: 20px; float: left;"><p>Cập nhật loại thiết bị đồ gỗ</p></h2>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
