...
<html lang="en">
  <head>
    ...
    <title>Thêm danh sách máy móc thiết bị</title>
  ...
  <body class="nav-md">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Thêm danh sách máy móc thiết bị</h3>
              </div>
              ...
              <form class="form-horizontal form-label-left" method="post" id="import_form" enctype="multipart/form-data">
                <div class="modal-body">
                  ...
                  <div class="form-group" style="text-align: center;">
                      <a style="font-style: italic;color: red; font-weight:bold" href="<?= public_url('bieumau/BM_THEMTB.xls') ?>">Tải biểu mẫu thêm (Cũ)</a> 
                      <a style="font-style: italic;color: red; font-weight:bold" href="<?= public_url('bieumau/BM_THEMTB_MOI.xls') ?>">Tải biểu mẫu thêm (Mới)</a><br>
                      <button type="button" class="btn btn-success" onclick="importAjax()"><i class="fa fa-upload" aria-hidden="true"></i> Tải lên mẫu cũ</button>

                      <button type="button" class="btn btn-success" onclick="importAjaxmoi()"><i class="fa fa-upload" aria-hidden="true"></i> Tải lên mẫu mới</button>
                  </div>

                </div>

              </form>
              <form class="form-horizontal form-label-left" method="post" action="<?= maymocthietbi_url('danhsachmaymocthietbicontroller/luuthietbi') ?>">
    ...
    <script type="text/javascript">
      ...
      function importAjax(){
        ...
        $.ajax({
          url:"<?php echo maymocthietbi_url('danhsachmaymocthietbicontroller/loadDataExcel_cu'); ?>",
          method:"POST",
          data:fd,
          contentType:false,
          cache:false,
      ...
      function importAjaxmoi(){
        ...
        $.ajax({
          url:"<?php echo maymocthietbi_url('danhsachmaymocthietbicontroller/loadDataExcel_moi'); ?>",
          method:"POST",
          data:fd,
          contentType:false,
          cache:false,
