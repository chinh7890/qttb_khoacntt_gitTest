...
<html lang="en">
  <head>
    ...
    <title>Loại máy móc thiết bị</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Danh sách loại máy móc thiết bị</h3>
              </div>
                            ...
                            <?php if ($this->session->userdata('quyenhan') == "1") : ?>
                              <td>
                                  ...
                                  <a class="btn btn-danger" onclick="return dialogDelete()" 
                                    href="<?php echo maymocthietbi_url('loaimaymocthietbicontroller/xoaloaimaymocthietbi/').$value['id']; ?>"
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title" id="exampleModalLongTitle" style="font-size: 20px; float: left;"><p>Thêm loại máy móc thiết bị</p></h2>
      ...
      <form class="form-horizontal form-label-left">
        <div class="modal-body">
          <div class="form-group">
                <label class="control-label col-md-2 col-sm-3 col-xs-12" for="first-name">Tên loại </label>
...
<div class="modal fade" id="modalsua" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title" id="exampleModalLongTitle" style="font-size: 20px; float: left;"><p>Cập nhật loại máy móc thiết bị</p></h2>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form class="form-horizontal form-label-left" action="capnhatloaithietbi" method="POST">
        <div class="modal-body">
          <div class="form-group">
                <label class="control-label col-md-2 col-sm-3 col-xs-12" for="first-name">Tên loại </label>
                <div class="col-md-9 col-sm-6 col-xs-12">
